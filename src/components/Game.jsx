...
function Game({ name, released, background_image, id }) {
  ...
  return (
    <NavLink to={`games/${id}`}>
      <motion.div className="shadow-game min-h-[30vh] mobile:min-h-[30vh] text-center rounded-md" onClick={loadDetailHandler} layoutId={id} variants={popIn} initial="hidden" animate="show">
